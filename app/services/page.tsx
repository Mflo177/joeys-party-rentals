    ...
    <div className="min-h-screen bg-gray-50 py-16 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
          ...
          <div className="space-y-3 text-gray-700">
            <p>• Small bounce house (10x10): <span className="font-bold">$75</span></p>
            <p>• Medium bounce house (15x15): <span className="font-bold">$125</span></p>
            <p>• Large bounce house (20x20): <span className="font-bold">$175</span></p>
          </div>
        </div>
